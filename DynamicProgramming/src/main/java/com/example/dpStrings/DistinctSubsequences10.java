...
public class DistinctSubsequences10 {
	...
	public static void main(String args[]) {
		...
		System.out.println(subsequenceCountingSpaceOptimization(s, t));
		System.out.println(subsequenceCountingSpaceOptimization1Array(s, t));
	}
	...
	private static int subsequenceCountingSpaceOptimization(String s, String t) {
		int n = s.length();
		int m = t.length();
...
//		}
	...
	private static int subsequenceCountingSpaceOptimization1Array(String s, String t) {
		int n = s.length();
		int m = t.length();
		int[] prev = new int[m + 1];
